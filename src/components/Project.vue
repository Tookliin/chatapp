  ...
  <main class>
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <p class="lead">
          Eat Good feel Good, Join A Number Of Healthy Fitness & Food Lovers
          ...
          <div class="blog1 card card-image">
            ...
            >
              <div class="text-dark">
                ...
                <p>
                  Rev up your usual routine by doing this 30-minute outdoor
                  workout circuit, developed by Vindum.
                </p>
                <p>
                  Try it in your backyard or at a local park—you'll burn about
                  250 calories with these outdoor exercises while firming up all
                  over.
                </p>
                <p>
                  Then be sure to keep reading for 10 more unique outdoor
                  workout ideas to keep things fresh and fun.
                </p>
                <a
          ...
          <div class="col mb-4">
            <div class="card h-100">
              ...
              <div class="view overlay">
                <img class="card-img-top" alt="Card image cap" width="50" />
                <a href="#!">
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <ul
                    class="list-unstyled list-inline d-flex justify-content-between mb-0"
                  >
                    <li class="list-inline-item mr-0">
                      <div class="chip mr-0">
                        Prep Time:
                        <span class="badge badge-pill badge-success"> min</span>
                      </div>
                    </li>
                    <li class="list-inline-item mr-0">
                      <div class="chip mr-0">
