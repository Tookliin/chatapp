...
<!-- This is an Project Page-->
      ...
      <div class="projects intro-2" style="height: 100vh">
       ...
       <h2 class="text-center text-uppercase font-weight-bold mt-5 mb-3 mt-5">My projects</h2>

<!--Section description-->
<p class="text-center text-uppercase font-weight-bold">All about my work</p>

<!--Section description-->
<p class="section-description mt-5 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error
