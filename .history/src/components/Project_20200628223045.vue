                      ...
                      <div class="col-md-6 ml-lg-5 ml-md-3">
                        ...
                        <div class="row pb-4">
                          ...
                          <div class="col-10">
                            ...
                            <ul>
                              <li>Data Capture </li><span>Dept Of Health Queenstown 2012</span>
                              <li>Data Quality Auditor/ Verification</li><span>PPECB 2017</span>
                              <li>Capa CITI</li><span>Java Developer Programe</span>
                              <li>Software Developer</li> <span>Compuscan/ Experian</span>
                              <li>Data Science Intern</li> <span>Akiba Digital</span>
                            </ul>
                          </div>
                        </div>
                        <!--Grid row-->
