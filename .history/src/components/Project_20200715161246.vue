...
<section class="dark-grey-text text-center ">
    ...
    <h3 class="font-weight-bold py-5 mt-3">Some Of My Work</h3>
    <p class="text-muted w-responsive mx-auto "> I have put some of the few projects i built, This projects are built with Django, Vue.js, Express, Node & Typescript. They are all part of RestAPI service. Databases i used PostgreSQL & MongoDB</p>
