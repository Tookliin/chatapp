    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          ...
          <p class="text-muted">This application is about, healthy living & Financial Management.
            </p>
            <span>We seek to motivate people how to stay innovative and healthy while working from home</span>
          <a class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
