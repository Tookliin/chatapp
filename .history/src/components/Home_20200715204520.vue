            ...
            <div class="container flex-center">
              <div class="white-text text-center">
                <div class="container py-5">
                    ...
                    <h3 class="font-weight-bold text-center  pb-2">Work Experience</h3>
                    <hr class="w-header my-4">
                    <p class="lead text-center pt-2 pb-3 mb-5">This are some of the companies i have worked for and worked with.</p>
                   ...
                   <div class="row dark-grey-text">
                      ...
                      <p class="text-white">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium eaque ipsa doloremque laudantium.</p>
                      </div>
        </div>
      </div>
