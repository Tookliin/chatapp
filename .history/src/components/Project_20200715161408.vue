...
<div class="py-5"></div>
    ...
    <p class="text-muted w-responsive mx-auto py-3"> I have put some of the few projects i built, This projects are built with Django, Vue.js, Express, Node & Typescript. They are all part of RestAPI service. Databases i used PostgreSQL & MongoDB</p>
