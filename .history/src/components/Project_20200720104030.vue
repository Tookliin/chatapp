<template>
    ...
    <h3 class="font-weight-bold text-center dark-grey-text pb-2">Company Projects</h3>
    <hr class="w-header my-4">
    <p class="lead text-center text-muted pt-2 mb-5">The following are some of the Projects i worked on with companies</p>
