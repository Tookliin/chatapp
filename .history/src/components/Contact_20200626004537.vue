...
<mdb-container>
    ...
    <div class="text-center">
       <mdb-btn size="lg" class="py-2 ml-3"  color="default">Submit</mdb-btn>
      <!-- <mdb-btn outline="secondary">Send <mdb-icon far icon="paper-plane" class="ml-1"/></mdb-btn> -->
      <mdb-btn gradient="aqua" rounded class="py-2 ml-3" size="lg"><mdb-icon far icon="paper-plane" class="mr-3"/>Submit</mdb-btn>
    </div>
  </form>
      </mdb-col>
