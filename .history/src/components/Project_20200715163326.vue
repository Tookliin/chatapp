...
<section class="dark-grey-text text-center " style="height: 110vh">
<div class="py-5"></div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          ...
          <p class="text-muted">Online shopping made easy by searching items on sale.</p>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mt-1 mb-3">Cheq-Me</h4>
          <p class="text-muted">Car, Bank Loan, House, Rental, Vacation & Date Night</p>
         
          <p class="text-muted">Minizing the risk and cutting long quing to check affordability at your bank, do it from your home.</p>
          <a class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mt-1 mb-3">Health Blog</h4>
          <p class="text-muted">Healthy living, Financial Management & Fitness.
            </p>
          
            <p class="text-muted">We seek to motivate people how to stay innovative and healthy while working from home</p>
          <a class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
   ...
   <section class="dark-grey-text text-center">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 mb-4">
        ...
        <h3 class="font-weight-bold">Some Of My Work</h3>
    <p class="text-uppercase text-center text-muted mt-4 mb-0"> I have put some of the few projects i built, This projects are built with Django, Vue.js, Express, Node & Typescript. They are all part of RestAPI service. Databases i used PostgreSQL & MongoDB</p>
