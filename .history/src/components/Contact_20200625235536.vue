...
<mdb-container>
    <mdb-row>
      <mdb-col class="col-lg-6 col-md-8 col-sm-12 mx-auto">
          <form name="contact" method="POST" netlify-honeypot="bot-field" data-netlify="true" class="w-100">
...
<script>
  import { mdbInput, mdbBtn, mdbTextarea, mdbContainer, mdbRow, mdbCol } from 'mdbvue';
  export default {
    name: 'Basic',
    components: {
      mdbInput,
