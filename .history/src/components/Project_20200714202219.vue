<template>
  ...
  <div class="row">
    ...
    <div class="col-sm">
    <span> <i class="fas fa-envelope purple-text fa-sm"> <a href="" class="teal-text" style="font-size: 1.2rem; font-weight: bold;"> maccoskuni@gmail.com</a></i> </span>
    <span> <i class="fas fa-envelope purple-text fa-sm"> makhoskun@outlook.com</i> </span>
    </div>
    <div class="col-sm">
