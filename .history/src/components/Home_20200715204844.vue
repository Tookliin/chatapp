            ...
            <div class="container flex-center">
              <div class="white-text text-center">
                <div class="container py-5">
                    ...
                    <h3 class="font-weight-bold text-center text-black pb-2">Work Experience</h3>
                    <hr class="w-header my-4">
                    <p class="lead text-center black-text pt-2 pb-3 mb-5">This are some of the companies i have worked for and worked with.</p>
