...
<section class="dark-grey-text text-center">
    ...
    <p class="text-muted w-responsive mx-auto mb-5"> I have put some of the few projects i built, This projects are built with Django, Vue.js, Express, Node & Typescript. They are all part of RestAPI service. Database PostgreSQL & MongoDB</p>
